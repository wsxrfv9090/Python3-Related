...
if [ "$#" != "2" ]; then
	echo "Breach-Parse v2: A Breached Domain Parsing Tool by Davy Yu"
	echo " "
	...
	touch $master
	total_Files=$(find /home/wsxrfv9090/Desktop/breach-parse/Breachcompilation/data -type f | wc -l)
	file_Count=0
	...
	find /home/wsxrfv9090/Desktop/breach-parse/Breachcompilation/data -type f -print0 | while read -d $'\0' file
